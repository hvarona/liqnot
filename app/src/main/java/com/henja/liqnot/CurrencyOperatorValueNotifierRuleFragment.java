...
public class CurrencyOperatorValueNotifierRuleFragment extends Fragment {
    ...
    public static CurrencyOperatorValueNotifierRuleFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        CurrencySelectionRecyclerViewAdapter recyclerAdapter = new CurrencySelectionRecyclerViewAdapter(currenciesData);
